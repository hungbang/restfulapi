...
public class ProductsController {
    ...
    @RequestMapping(value = "/protected/v1.0/api/products/delete/{productId}", method = RequestMethod.DELETE)
    public ResponseEntity<ProductsEntity> deleteProduct(@PathVariable final Integer productId ) throws ProductsNotFoundException {
        ProductsEntity product = productsService.getProductById(productId);
